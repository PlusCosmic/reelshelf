 ...
 */
export function instanceOfGameCategoryResponse(
  value: object,
): value is GameCategoryResponse {
...
export function GameCategoryResponseFromJSONTyped(
  json: any,
...
export function GameCategoryResponseToJSONTyped(
  value?: GameCategoryResponse | null,
