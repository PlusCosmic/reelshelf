...
import { IconPlaylistAdd, IconPlus, IconVideo } from "@tabler/icons-react";
import { useNavigate } from "@tanstack/react-router";
import { addClipsToPlaylist, fetchPlaylists } from "@/shared";
      ...
      >
        ...
        <Menu.Dropdown
          style={{
            ...
            boxShadow:
              "0 10px 40px rgba(0, 0, 0, 0.5), 0 0 30px rgba(168, 85, 247, 0.1)",
          }}
        >
          {/* Header */}
          <Menu.Label>
