...
import { fetchPlaylistById, removeClipFromPlaylist } from "@/shared";
...
export function PlaylistQueueSidebar({
  ...
  const [
    collaboratorsOpened,
    { open: openCollaborators, close: closeCollaborators },
  ] = useDisclosure(false);
        ...
        <Group wrap="nowrap" gap="sm">
          ...
          <div
            style={{
              ...
              aspectRatio: "16/9",
              background:
                "linear-gradient(135deg, rgba(0, 212, 255, 0.05) 0%, rgba(168, 85, 247, 0.05) 100%)",
              borderRadius: "4px",
            }}
          />
