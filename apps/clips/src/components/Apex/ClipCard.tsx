...
import { ActionIcon, Badge, Box, Card, Group, Image, Stack, Text, Tooltip, UnstyledButton } from "@mantine/core";
import { IconClock, IconDownload, IconEdit, IconShare, IconTrash } from "@tabler/icons-react";
import { Link, useNavigate } from "@tanstack/react-router";
import { apiConfig, deleteVideo, downloadVideo } from "@repo/shared";
...
export function ClipCard({ clip }: ClipCardProps) {
  ...
  const handleDelete = (e: React.MouseEvent) => {
    ...
    modals.openConfirmModal({
      ...
      children: (
        <Text size="sm">
          Are you sure you want to delete "{clip.video.title}"? This action cannot be undone.
        </Text>
      ),
  ...
  const handleEdit = (e: React.MouseEvent) => {
    ...
    navigate({ to: '/apex-legends/$clipId', params: { clipId: clip.clipId } });
  };
