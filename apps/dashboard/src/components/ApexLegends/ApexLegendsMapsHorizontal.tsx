        ...
        <Group justify="flex-start">
          <div>
            ...
            <Group justify="space-between" mb="xs">
              ...
              {!isLoading && mapRotation && (
                <Text size="sm" c="dimmed">
                  {formatRemainingTime(
                    mapRotation.standard.current.remainingMins,
                  )}{" "}
                  remaining
                </Text>
              )}
              {isLoading && <Skeleton width={60} height={8} radius="xl" />}
            </Group>
            <Group justify="flex-start" mb="xs">
              ...
              {!isLoading && mapRotation && (
                <Stack justify="center" gap={0}>
                  ...
                  <Text c="dimmed" size="xs">
                    Until{" "}
                    {new Date(
                      mapRotation.standard.current.end,
                    ).toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                      hour12: false,
              ...
              {isLoading && (
                <Stack>
                  <Skeleton width={60} height={8} radius="xl" />
                  <Skeleton width={60} height={8} radius="xl" />
                </Stack>
              )}
            </Group>
              ...
              {!isLoading && mapRotation && (
                <Stack justify="center" gap={0}>
                  ...
                  <Text c="dimmed" size="xs">
                    Starts at{" "}
                    {new Date(
                      mapRotation.standard.next.start,
                    ).toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                      hour12: false,
              ...
              {!isLoading && mapRotation && (
                <Stack justify="center" gap={0}>
                  ...
                  <Text c="dimmed" size="xs">
                    Until{" "}
                    {new Date(
                      mapRotation.ranked.current.end,
                    ).toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                      hour12: false,
