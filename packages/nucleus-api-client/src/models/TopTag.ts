...
export function TopTagFromJSONTyped(json: any, ignoreDiscriminator: boolean): TopTag {
    if (json == null) {
        return json;
    }
    return {
...
export function TopTagToJSONTyped(value?: TopTag | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
