...
- Adding a clip to a playlist requires the actor to already have access to that clip, since playlist membership itself grants access. Gaming-session participants are limited to people who already share a playlist with the caller.
