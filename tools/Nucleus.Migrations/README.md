...
The clips service compose file runs this project as a one-shot `nucleus-migrations` container and makes the clips API service depend on successful completion. Keep a single migration owner per database.
