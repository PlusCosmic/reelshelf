...
public static class PlaylistEndpoints
{
    public static void MapPlaylistEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("gaming-session", CreateGamingSessionPlaylist).WithName("CreateGamingSessionPlaylist")
            .RequirePermission(Permissions.PlaylistsManage);
        group.MapPost("gaming-sessions", EnsureGamingSessionPlaylist).WithName("EnsureGamingSessionPlaylist")
            .RequirePermission(Permissions.PlaylistsManage);
    ...
    private static async Task<Results<Ok<PlaylistWithDetails>, BadRequest<string>>> EnsureGamingSessionPlaylist(
        AutoGeneratedGamingSessionPlaylistService gamingSessionPlaylistService,
        EnsureGamingSessionPlaylistRequest request,
        AuthenticatedUser user)
    {
        try
        {
            PlaylistWithDetails playlist = await gamingSessionPlaylistService.EnsureGamingSessionPlaylist(
                request.CategoryId,
                request.SessionDate,
                request.ClipIds,
                request.Timezone,
